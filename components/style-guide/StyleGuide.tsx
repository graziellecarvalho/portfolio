	...
	return (
		<Component>
			...
			<Container>
				...
				{/* Font Family */}
				<Section id="font-family" className="mb-9">
					<span className="font-weight-bold text-black">Font Family</span>
					<hr className="mt-0" />

					<Row>
						<Col md={6} className="text-right border-right">
							<h2>Josefin Sans</h2>

							<p>Most used on headings and buttons</p>

							<br />

							<p>Variations: </p>

							<p className="mb-0">Josefin Regular</p>
							<p className="font-italic mb-0">Josefin Italic</p>
							<p className="font-weight-bold mb-0">Josefin Bold</p>
							<p className="font-weight-bold font-italic mb-0">Josefin Bold Italic</p>
						</Col>
						<Col md={6}>
							<h2>Montserrat</h2>

							<p>Most used on p and span tags</p>

							<br />

							<p>Variations: </p>

							<p className="mb-0">Montserrat Regular</p>
							<p className="font-italic mb-0">Montserrat Italic</p>
							<p className="font-weight-bold mb-0">Montserrat Bold</p>
							<p className="font-weight-bold font-italic mb-0">Montserrat Bold Italic</p>
						</Col>
					</Row>
				</Section>
